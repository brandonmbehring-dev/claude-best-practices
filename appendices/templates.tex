...
{\footnotesize \textit{Note: Permission rules support both glob syntax
(\code{Bash(git push *)}, \code{Edit(/src/**/*.ts)})
and colon-style constraints (\code{WebFetch(domain:example.com)}).
