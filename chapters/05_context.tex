...
for selective summarization.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/best-practices}}
...
\begin{description}
  ...
  \item[\code{/rewind}] Checkpoint and roll back to a previous state.
    Use when Claude went down a wrong path and you want to revert
...
\code{--resume}, \code{--from-pr}.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/overview}}
...
## Why
Current sync handlers cause 200ms latency spikes
under load.

## Next Step
Write integration tests for the new async
PaymentProcessor class.

## Context When I Return
- PaymentProcessor class is in
  src/payments/processor.py
- 3 of 5 handler methods converted, 2 remaining
- Tests in tests/payments/ — existing tests pass
\end{minted}
\end{beforeafter}
\end{fullwidth}
...
automatically. Memory files persist in \code{\textasciitilde/.claude/projects/*/memory/}.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/memory}}
...
before implementation.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/overview}}
