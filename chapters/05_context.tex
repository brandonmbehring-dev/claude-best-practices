...
\end{tikzpicture}
\caption{Context composition over time. Noise (old errors, abandoned approaches)
  grows fastest, crowding signal. The 60\% threshold marks where quality drops
  non-linearly.}
...
metrics in real time.} By default it shows the active model, git branch,
