...
\begin{description}
  \item[Code intelligence plugins] For typed languages, these give Claude
    precise symbol navigation and automatic error detection after edits.
    If you work with TypeScript, Rust, Go, or Java, install one immediately.
