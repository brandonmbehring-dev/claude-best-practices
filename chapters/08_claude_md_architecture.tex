...
external files without duplicating content.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/memory}}
...
frontmatter to control when they load.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/best-practices}}
...
\marginwarning{Beyond $\sim$300--500 lines, attention per rule tends to decrease.
This is heuristic, not a hard threshold---but the effect is real.}
