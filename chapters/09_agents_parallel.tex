...
description: Review code for security vulns
...
% -------------------------------------------------------------------
\begin{trybox}
Identify one task that currently takes you more than 10 minutes sequentially.
Design a 2-agent parallel split:
\begin{enumerate}
  \item What does Agent 1 do? What tools does it need?
  \item What does Agent 2 do? What tools does it need?
  \item Are the tasks truly independent? (If Agent 2 needs Agent 1's output, they cannot run in parallel.)
