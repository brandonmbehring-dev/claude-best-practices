...
\code{any} everywhere will cause inconsistent code---some files strict, some loose.
...
\begin{enumerate}
  \item Have Claude write characterization tests without telling it
    what the function \emph{should} do. Just: ``Document what it does today.''
  \item Run the tests. Do they pass?
  \item If yes: you now have a safety net for refactoring.
    If no: you have discovered undocumented behavior.
