...
\code{--output-format json|stream-json|text}.\sourceurl{https://docs.anthropic.com/en/docs/claude-code/overview}}
...
\margintip{Always test on 3--5 files before scaling.
The prompt that works on your first file may fail on edge cases in file 47.}
