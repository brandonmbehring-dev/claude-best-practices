...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Model} & \textbf{Input} & \textbf{Output} & \textbf{Notes} \\
\midrule
Haiku 4.5 & \$1 & \$5 & Fastest, lowest cost \\
Sonnet 4.6 & \$3 & \$15 & Best balance for daily development \\
Opus 4.6 & \$5 & \$25 & Frontier reasoning, 1M context \\
Opus 4.6 (fast) & \$30 & \$150 & 2.5$\times$ faster (research preview) \\
\midrule
\multicolumn{4}{@{}l}{\textit{Discounts (combinable):}} \\
Cache reads & \multicolumn{3}{@{}l}{90\% off input (0.1$\times$ base price)} \\
Batch API & \multicolumn{3}{@{}l}{50\% off input and output} \\
\bottomrule
\end{tabular}
\end{fullwidth}
