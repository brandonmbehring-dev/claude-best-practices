...
2 & Expand (15 developers) & Deploy managed-settings.json. Add PreCommit hooks.
...
\official{Government deployment options include:}

\begin{description}
  \item[FedRAMP High] Available via Palantir FedStart integration.
  \item[AWS GovCloud] Cloud-native deployment for IL6+ requirements.
  \item[Google Vertex Assured] Alternative cloud deployment for regulated workloads.
\end{description}

\marginnote[Enterprise]{Check \url{https://claude.com/solutions/government}
for current government offering details, as program terms change frequently.}
