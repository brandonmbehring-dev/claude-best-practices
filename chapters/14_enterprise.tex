...
\official{Anthropic holds industry-leading certifications:\sourceurl{https://privacy.claude.com/en/articles/10015870-what-certifications-has-anthropic-obtained}}
...
\begin{description}
  ...
  \item[FedRAMP High] US government cloud security baseline (via Palantir FedStart).
