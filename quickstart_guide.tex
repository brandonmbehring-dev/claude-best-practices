...
\begin{center}
  ...
  {\large The Mindset Shift and Test-Driven Development}\\[6pt]
...
% =====================================================================
\section{The Mindset Shift: Agent, Not Chatbot}
...
% =====================================================================
\section{Five Minutes to Productive: CLAUDE.md}
...
% =====================================================================
\section{Test-Driven Development with Claude}
...
\begin{minted}{json}
{
  "hooks": {
    "PostFileWrite": [{
      ...
      "description": "Auto-lint every written file"
    }],
    "PreCommit": [{
...
% =====================================================================
\section{Phase-Appropriate Rigor}
...
% =====================================================================
\section{The Five Traps (and How to Escape)}
...
\begin{tikzpicture}[
  ...
  \node[wfstep, below=of s2] (s3) {Prompt with specs + ``write tests first''};
  \node[wfstep, below=of s3] (s4) {Observe output, check diffs and tests};
  \node[wfstep, below=of s4] (s5) {Refine (specific feedback) or \code{/clear} + retry};
  \node[wfstep, below=of s5] (s6) {Commit one logical change};
...
\begin{center}
\footnotesize
\textit{Extracted from ``Best Practices for Using Claude'' (v2.0).}\\
\textit{Full handbook: 14 chapters covering foundations through enterprise deployment.}\\[4pt]
